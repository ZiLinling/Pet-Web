<template>
    <el-dialog :title="title" :visible="visible" :close-on-click-modal="false" :before-close="handleClose">
        <el-form :model="form" :rules="rules" label-width="100px" ref="form">
            ...
            <el-form-item label="库存" prop="stock" placeholder="请填写商品库存">
                <el-input v-model="form.stock" autocomplete="off" style="width:30%"></el-input>
            </el-form-item>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                status: [
                    { required: true, message: '请设置商品状态', trigger: 'change' }
                ],
            }
        }
    },

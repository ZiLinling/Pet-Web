    ...
    <div class="app-container">
        <pageTable @load-table-data="loadTableData" ref="dataTable" row-key="id" @selection-change="selectionChange">
            <template slot="function-button">
                ...
                <div class="search">
                    <div>物种
                        <el-select v-model="searchData.specie" filterable clearable placeholder="请选择">
            ...
            <template slot="tb-columns">
                ...
                <el-table-column prop="name" label="品种" width="180" align="center"></el-table-column>
                <el-table-column label="类别" width="180" align="center">
                    <template slot-scope="scope">
                        {{ species[scope.row.specie - 1].name }}
                    </template>
                </el-table-column>
...
import Edit from '@/components/Edit/BreedEdit'
    ...
    methods: {
        ...
        del(ids, imgs) {
            ...
            this.$confirm("是否删除?", "提示", {
                ...
                postRequest("/breed/delete", { ids: ids }).then((response) => {
